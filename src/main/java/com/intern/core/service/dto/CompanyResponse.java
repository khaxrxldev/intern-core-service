...
public class CompanyResponse {
	...
	private Boolean companyApplyBtn;
	...
	public Boolean getCompanyApplyBtn() {
		return companyApplyBtn;
	}

	public void setCompanyApplyBtn(Boolean companyApplyBtn) {
		this.companyApplyBtn = companyApplyBtn;
	}
}
